...
export async function POST(request: Request) {
  try {
    ...
    console.log("[v0] YouTube upload starting:", { videoUrl, title, privacy, isShort, keywords })
    ...
    return NextResponse.json({ error: error.message || "YouTube upload failed" }, { status: 500 })
  }
}

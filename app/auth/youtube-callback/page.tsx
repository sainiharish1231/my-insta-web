...
export default function YouTubeCallback() {
  ...
  useEffect(() => {
    const handleCallback = async () => {
      ...
      console.log("[v0] YouTube callback received:", {
        hasCode: !!code,
        error: errorParam,
      });
      ...
      try {
        ...
        if (!res.ok || data.error) {
          ...
          throw new Error(
            data.error || data.details || "Failed to authenticate with YouTube",
          );
        }

        console.log(
          "[v0] YouTube authentication successful, storing account data",
        );
        ...
        const existingIndex = existingYTAccounts.findIndex(
        ...
        localStorage.setItem(
          "youtube_accounts",
          JSON.stringify(existingYTAccounts),
        );

...
import { generateHashtags } from "@/lib/meta";
...
export function HashtagPicker({
  ...
  const toggleHashtag = (hashtag: string) => {
    const newSelected = selected.includes(hashtag)
    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-2">
        <input
          ...
          value={customHashtag}
          onChange={(e) =>
            setCustomHashtag(e.target.value.replace(/[^a-zA-Z0-9]/g, ""))
          }
